...
{
	T* _array;			 ///массив с данными типа “
	size_t _size;		 ///размер данных, зранипмых в структуре
	const size_t _vec=100;   ///шаг увеличени€ пам€ти
	size_t _alloc;		 ///размер аллоцированного простанства пам€ти, увеличиваетс€ на размер _vec
