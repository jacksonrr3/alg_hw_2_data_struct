...
int main() {
	...
	std::cout << (sa->size()) << std::endl;
	std::cout << (sa->get(1)) << std::endl;
	std::cout << (sa->get(2)) << std::endl;
	print_array(sa);
	sa->add(3);
	std::cout << (sa->size()) << std::endl;
	std::cout << (sa->get(1)) << std::endl;
	std::cout << (sa->get(2)) << std::endl;
	std::cout << (sa->get(3)) << std::endl;
	std::cout << (sa->size()) << std::endl;
	std::cout << (sa->get(5)) << std::endl;
	print_array(sa);
	std::cout << (sa->remove(5)) << std::endl;
	print_array(sa);
	std::cout << (sa->get(5)) << std::endl;
	std::cout << (sa->size()) << std::endl;
	print_array(sa);
